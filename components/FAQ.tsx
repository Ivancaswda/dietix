...
const faqs = [
    {
        question: "Как работает сервис SmartDiet?",
    ...
    {
        question: "Можно ли экспортировать диету?",
        answer: "Да, все диеты можно экспортировать в PDF или сохранить для дальнейшего использования на мобильных устройствах.",
    },
];
