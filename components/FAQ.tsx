...
const faqs = [
    ...
    },
    {
        ...
        answer: "У нас есть бесплатный тариф с ограниченными возможностями и с добавлением gemini ключа , а также Basic (1 месяц) и Premium  (3 месяца) тарифы  с расширенными функциями и неограниченным доступом к диетам.",
    },
    {
